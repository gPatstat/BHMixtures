...
for(par_id in 1:3){
  for(sim_id in 1:50){
    ...
    set.seed(seed)
    F_sample=F_simulator_lm(m=m,n=n,sd_perc=0.01,mu_p=mu_p)
    ...
    save(EM_sample,pca_basis,F_sample,get_basis, file = paste("C:/Users/test/OneDrive - Politecnico di Milano/Desktop/BHMixtures/Sim_B_lm/simB_lm_sim",sim_id,"par",param_b,"seed",seed,".rdata"))
    print(sim_id)
  }
}
