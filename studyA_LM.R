...
for(par_id in 1:4){
  for(sim_id in 1:nsim){
    ...
    set.seed(seed)
    F_sample=F_simulator_lm(m=m,n=n,sd_perc=param_a)
    ...
    save(EM_sample,pca_basis,F_sample,get_basis, file = paste("C:/Users/test/OneDrive - Politecnico di Milano/Desktop/BHMixtures/Sim_A_lm/simA_lm_sim",sim_id,"par",param_a,"seed",seed,".rdata"))
    print(sim_id)
  }
}
